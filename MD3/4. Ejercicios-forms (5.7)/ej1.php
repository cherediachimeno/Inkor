...
if(isset($_REQUEST['enviar'])){
    ...
    $web = match ($seleccion) {
        '1' => 'https://007.com',
        '2' => 'https://indianajones.com',
        '3' => 'https://www.paramountpictures.com/movies/godfather-collection',
        '4' => 'https://www.lotro.com/home',
    };
}
...
<body>
    <h1>Resultados</h1>
    <div class="card resolucion">
        <img class="card-img-top resolucionImagen" src='<?=$imagen?>' height='100px' width='100px'>
        <div class="card-body">
        <h5 class="card-title">Película elegida</h5>
        <p class="card-text"><?=$sinopsis?></p>
        <a href="<?=$web?>" class="btn btn-primary">Web oficial</a>
        </div>
    </div>
